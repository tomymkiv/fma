...
function Carousel(props: Props) {
    ...
    return (
        <div className="overflow-hidden flex flex-col relative w-full max-w-[320px] md:max-w-[550px] xl:max-w-[800px]">
            <div className="flex relative">
                <button onClick={prevSlide} className="absolute left-0 z-3 top-[45%] p-2.5 bg-[#0007] hover:bg-[#000b] transition-background duration-400 cursor-pointer ease-in-out">
                ...
                <div className="flex transition-transform ease-in duration-600 w-full" style={{
                    transform: `translateX(-${curr * 100}%)`
                }}>{children}
                </div>
                <button onClick={nextSlide} className="absolute right-0 z-2 top-[45%] p-2.5 bg-[#0007] hover:bg-[#000b] transition-background duration-400 cursor-pointer ease-in-out">
